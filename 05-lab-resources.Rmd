...
## Google account:
**Gmail**: We have a riplrt email domain: username@riplrt.com. All emails related to RIPLRT should be communicated through this email domain. Make sure to ask Dr. Rivera-Mariani to add you to our domain if you are a Research Assistant, otherwise make sure to have a gmail.com account. **Google drive**: there is a riplrt drive (https://drive.riplrt.com) that will contain all documents shared intra-lab only, including collaborations. Similar to the email with the @riplt.com domain, only Research Assistants will have direct acces. If you are not in the Research Assistant category, make sure to ask Dr. Rivera-Mariani to send you invites for the correspondig folders in the drive. **Google calendar**: invites to events and meetings are sent through Google calendar.   
...
## WhenIWork
In order to keep track of the hours worked in the lab, we implement the [WhenIWork](https://login.wheniwork.com/) platform for signing in and out. WhenIWork (or WIWI as we often refer to it) allows Dr. Rivera-Mariani Rivera to create a schedule on the master account with tasks, shifts, and time slots for RIPLRT members. The Lab Manager also has the permission to assign tasks. Another important feature is the desktop sign in sheet that lab members can access on RIPLRT’s computer. Now lets say that the computer is unaccessible, you have to option of signing in on your smartphone that will track your sign in and out location via GPS.
